...
<head>
	...
	<script type="text/javascript">
		window.onload = function(){
			...
			document.getElementById("aboutNav").className = "nav-item disabled";
	...
	<div class="cards bg-dark text-white my-5" id="cards-about">
		<img src="img/ban7.png" class="cards-img" alt="banner">
	</div>
